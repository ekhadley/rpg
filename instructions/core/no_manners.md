...
Mannered prose replaces a plain statement with a metaphor or flourish that displays the writer instead of conveying the idea ("a dial worth turning" for "a parameter worth varying," "earns its keep" for "still matters", etc.) which makes the reader work harder and brings in connotations the writer never chose. Say what you mean. When a literal phrase is available, use it.
